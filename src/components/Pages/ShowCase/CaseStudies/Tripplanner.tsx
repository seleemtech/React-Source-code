...
import mainImage from "../../../assets/img/blog/style2/7.png";
import CaseForm from "../../../CaseForm/CaseForm";
import CaseFormEmail from "../../../CaseForm/CaseFormEmail";
const normalData = [
  {
    title: "Business Need",
    desc: "Client wants to build a trip planner application to provide the information for the Citizens of Malaysia and other countries to plan their trips based on their point of interest.",
  },
  {
    title: "Challenges",
    desc: "The existing application had limited features wasn't flexible and extendable to address the client's business needs of planning the trips based on the point of interest.",
  },
];
const listData = [
  {
...
const TripPlanner = () => {
  ...
  const [document] = usePrismicDocumentByUID("case_type", "case2");
  const slice = document && document?.data;
  const bg = {
    backgroundImage: `url(${
      slice ? slice?.body[0]?.primary?.case_bg_img.url : "/casePlaning.jpeg"
    })`,
  ...
  return (
    <React.Fragment>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Client wants to build a trip planner application to provide the information for the Citizens of Malaysia and other countries to plan"
        />
        <link rel="canonical" href="http://esquareinfo.com/case-Studies/Case2"/>
      </Helmet>
