...
const bg = {
  backgroundImage: `url("/caseBugt.jpeg")`,
...
const Budgetplanning = () => {
  ...
  const [document] = usePrismicDocumentByUID("case_type", "case11");
  const slice = document && document?.data;
  const bg = {
    backgroundImage: `url(${
      slice ? slice?.body[0]?.primary?.case_bg_img.url : "/caseBugt.jpeg"
    })`,
    backgroundSize: "cover",
    backgroundPosition: "right",
    height: "510px",
  ...
  return (
    <React.Fragment>
      ...
      <Helmet>
        ...
        />
        <link rel="canonical" href="http://esquareinfo.com/case-Studies/Case11"/>
      </Helmet>
