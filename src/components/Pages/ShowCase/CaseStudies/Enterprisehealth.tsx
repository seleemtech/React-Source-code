...
const normalData = [
  {
    title: "Business Need",
    desc: "Client wants to build An Enterprise HealthCare portal for maintaining the Medicaid program of different states in the USA. This system should allow the poor and senior citizens to enroll as members, it allows the service provider (doctors, hospitals, lab technicians, ambulance services, etc) to enroll.",
  },
  {
    title: "Challenges",
    desc: " The existing portal had limited features wasn't flexible and extendable to address the client's business needs mentioned below. The system is should handle the use case base of 30 million for states like Florida and New York, with few thousands of Providers, Over a million claims should be processed every week Internal Efficiencies, Workflow management, Automation and Integrations. Secure and Sustainable Platform.",
  },
];
const listData = [
  {
  ...
  {
    list: "Flexible and Robust Contact Management.",
  },
  {
    list: "Robust Provider Registration, Application and Inquiry.",
  },
  {
    list: "Ease of maintenance of Members and Providers.",
  },
];
...
const Enterprisehealth = () => {
  ...
  const [document] = usePrismicDocumentByUID("case_type", "case3");
  const slice = document && document?.data;
  const bg = {
    backgroundImage: `url(${
      slice ? slice?.body[0]?.primary?.case_bg_img.url : "/caseHealthbg.jpeg"
    })`,
  ...
  return (
    <React.Fragment>
      ...
      <Helmet>
        <title>Enterprise Health Care</title>
        <meta
          name="description"
          content="Client wants to build An Enterprise HealthCare portal for maintaining the Medicaid program of different states in the USA."
        />
        <link rel="canonical" href="http://esquareinfo.com/case-Studies/Case3"/>
      </Helmet>
      ...
      >
        <div className="container">
          <div className="row">
            ...
            <div
              className="col-lg-7 col-md-6 mb-50 textStyle"
              data-aos="fade-up"
              data-aos-duration="1500"
            >
